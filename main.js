...
const methods = [
    ...
    { id: "method4", text: "<p>Referencias en tiempo real del estado de tus envíos.<br><br> Además, contás con nuestros canales de atención inmediata via WhatsApp.<p>", imgSrc: "./soporte.jpg" }
  ];
